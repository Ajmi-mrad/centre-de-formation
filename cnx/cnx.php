...
if (isset($_POST['adresse']) && isset($_POST['mdp'])) {
  ...
  if ($user) {
    ...
    die("<script>alert('Desole les infromations incorrect')
    document.location='cnx.php'</script>");
  }
}
...
<div class="container" id="container">
  ...
  <img src="logo.jpg" class="rounded"> -->
<!-- </div> --> <div class="logo_edraak">
                ...
                <input name="mdp" type="password" placeholder="Mot de passe"/>
                <!-- <a href="modif.php?id_login=<?= $id_login?>" target="_blank">J'ai oublié mon mot de passe</a> -->
                <!-- <a href="modif.php?id_login=<?= $id_login?>" target="_blank">Je peux modifier mon mot de passe</a> -->
        ...
        <div class="overlay-container">
            <div class="overlay">
                <div class="overlay-panel overlay-left">
                    ...
                    <a class="ghost" id="signIn">S'identifier</a>
                </div>
