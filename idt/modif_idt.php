...
$old_idt= idt_fetch_id($conn, $num_id);
// print_r($num_id);
if (isset($_POST['ok'])) {
...
<?php require_once '../menu1.php'; ?>
    <div class="container m-5">
        <form method="post">
            <h1>Les types d'ientifiant de clients/formateurs</h1>
            <h3>Informations</h3>
            <div class="row g-3">
                <div class="col">
                <label for="formGroupExampleInput" class="form-label"  >L'identifiant client/foramteur </label>
                    <input type="text" class="form-control" name="libelle" placeholder="Tapez l'identifiant" value="<?= $old_idt['libelle'] ?>">
                </div>
            </div>
            <br>
            <hr>
