...
if (!isset($_SESSION['user'])) {
    ...
    if (isset($_POST['ok']) || isset($_POST['cancel'])) {
        if (isset($_POST['ok'])) {
            ...
            insert_formateur_paiement($conn, [
        ...
        // header("location: liste_formateur_paiements.php");    
        }
    ?> 
...
<?php require_once '../menu1.php'; ?>
    <?php
    $formateurs_session = formateur_session_fetch_id($conn, $id_formation,$id_session,$id_formateur);
    ?>
            ...
            <table class="table">
                <thead>
                    ...
                    <tr>
                        ...
                        <td><?= $formateurs_session['nom_formation'] ?></td>
                        <td><?= $formateurs_session['nom_session'] ?></td>
                        <td><?= $formateurs_session['nom_formateur'] ?></td>
                        <td><?= $formateurs_session['mt_tt'] ?></td>
